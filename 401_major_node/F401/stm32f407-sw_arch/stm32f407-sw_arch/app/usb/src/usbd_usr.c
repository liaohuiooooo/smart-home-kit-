...
{
  wjq_log(LOG_INFO, USER_INFORMATION1);
   wjq_log(LOG_INFO, USER_INFORMATION2);
...
{
   wjq_log(LOG_INFO, "> MSC Interface started.\n");
}
/**
...
{
     wjq_log(LOG_INFO, "> Device In suspend mode.\n");
}
...
{
   wjq_log(LOG_INFO, "> USB Device Connected.\n");
}
...
{
   wjq_log(LOG_INFO, "> USB Device Disconnected.\n");
}
